...
class PolyhedronGeometryVertex extends Vector3 {
  int index;
  UV uv;
  PolyhedronGeometryVertex([num x = 0.0, num y = 0.0, num z = 0.0])
      : super.fromFloat32List(new Float32List.fromList(
            [x.toDouble(), y.toDouble(), z.toDouble()]));

  PolyhedronGeometryVertex.fromVector3(Vector3 other)
      : super.fromFloat32List(
            new Float32List.fromList([other.x, other.y, other.z]));
}
