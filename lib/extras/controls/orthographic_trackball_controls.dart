...
class OrthographicTrackballControls extends EventEmitter {
  ...
  OrthographicTrackballControls(this.object, [Element domElement]) {
    ...
    left0 = this.object.left;
    right0 = this.object.right;
    top0 = this.object.top;
    bottom0 = this.object.bottom;
  ...
  zoomCamera() {
    if (_state == STATE.TOUCH_ZOOM) {
      ...
      object.left = _zoomFactor * left0 + (1 - _zoomFactor) * center0.x;
      object.right = _zoomFactor * right0 + (1 - _zoomFactor) * center0.x;
      object.top = _zoomFactor * top0 + (1 - _zoomFactor) * center0.y;
      object.bottom = _zoomFactor * bottom0 + (1 - _zoomFactor) * center0.y;
    } else {
