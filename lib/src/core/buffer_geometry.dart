...
GeometryAttribute<Float32List> float32GeometryAttribute(int numItems,
        [int itemSize = 1]) =>
    new GeometryAttribute<Float32List>._internal(
        new Float32List(numItems), itemSize);

GeometryAttribute<Int16List> int16GeometryAttribute(int numItems,
        [int itemSize = 1]) =>
    new GeometryAttribute<Int16List>._internal(
        new Int16List(numItems), itemSize);
    ...
    if (aPosition != null && aIndex != null) {
      ...
      if (aNormal == null) {
        attributes[GeometryAttribute.NORMAL] =
            float32GeometryAttribute(aPosition.numItems, 3);
      } else {
