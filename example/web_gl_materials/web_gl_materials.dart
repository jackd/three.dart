...
init() {
  ...
  camera = new PerspectiveCamera(
      45.0, window.innerWidth / window.innerHeight, 1.0, 2000.0);
  ...
  materials
    ...
    ..add(new MeshBasicMaterial(
        color: 0xffaa00, transparent: true, blending: AdditiveBlending))
  ...
  var geometry_pieces = new SphereGeometry(
      70.0, 32, 16); // Extra geometry to be broken down for MeshFaceMaterial
  ...
  particleLight = new Mesh(
      new SphereGeometry(4.0, 8, 8), new MeshBasicMaterial(color: 0xffffff));
  ...
  var directionalLight =
      new DirectionalLight(/*Math.random() * */ 0xffffff, 0.125);
